...
/**
 * Created by António "Curtes Malteser" Bastião on 08/03/2018.
 */


public class RadarChartOriginal extends View {

    private int width, height = 0;
    int radius = 0;
    private double[] numbers = {1, 2, 3, 4, 5, 6};
    ...
    public RadarChartOriginal(Context context) {
        super(context);
    }

    public RadarChartOriginal(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
